...
#define KeyRepeat 0x0004 // after a key is pressed & held for one
second
    ...
    if (sIndex < Number_of_Cols)
    {
        ...
        for (sIndex = 0; sIndex < Number_of_Keys; sIndex++)
        {
                ...
                sKeyControl[sIndex].sKeyReadTempPos)
            {
                ...
                sKeyStatus |= KeyRepeat; // a new key comes in, set the repeat
                flag
                    sIndexCopy = sIndex; // save a copy of sIndex for push &
                held use break;
            }
...
void key1R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_1_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void key2R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_2_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void key3R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_3_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void key4R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_4_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void key5R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_5_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void key6R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_6_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void key7R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_7_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void key8R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_8_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void key9R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_9_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void key0R()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_0_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void keySR()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_S_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
void keyPR()
{
    HAL_UART_Transmit(&huart2, (uint8_t *)"Key_P_Repeated", 14, HAL_MAX_DELAY);
    HAL_UART_Transmit(&huart2, (uint8_t *)"\n\r", 2, HAL_MAX_DELAY);
}
